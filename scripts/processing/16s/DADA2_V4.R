...
source('scripts/processing/16s/DADA2_paired.R')
source('scripts/processing/16s/DADA2_single.R')
...
rawdata_path <- "data/16s/16s_clayton_captive/raw_fastq" 
outdir <- "results/16s/processing/16s_clayton_captive/DADA2" 
...
###GOODRICH####
#define input fastqs, sample names, outdir
rawdata_path <- "data/16s/16s_goodrich/raw_fastq" 
outdir <- "results/16s/processing/16s_goodrich/DADA2" 
...
###NISHIDA_CAPTIVE####
rawdata_path <- "results/16s/processing/16s_nishida_captive/demultiplexed_fastq" 
outdir <- "results/16s/processing/16s_nishida_captive/DADA2" 
...
#define input fastqs, sample names, outdir
rawdata_path <- "results/16s/processing/16s_nishida_projectchimps/cutadapt_fastq" 
outdir <-  "results/16s/processing/16s_nishida_projectchimps/DADA2" 
...
###RAYMANN###
#define input fastqs, sample names, outdir
rawdata_path <- "results/16s/processing/16s_raymann_captive/cutadapt_fastq" 
outdir <-  "results/16s/processing/16s_raymann_captive/DADA2" 
(forward_reads <- sort(list.files(rawdata_path, pattern="_R1_001.fastq", full.names = TRUE)))
(reverse_reads <- sort(list.files(rawdata_path, pattern="_R2_001.fastq", full.names = TRUE)))
...
###SMITS####
#define input fastqs, sample names, outdir
rawdata_path <- "data/16s/16s_smits_2017/raw_fastq"  
outdir <-  "results/16s/processing/16s_smits_2017/DADA2" 
(forward_reads <- sort(list.files(rawdata_path, pattern="_1.fastq.gz", full.names = TRUE)))
(reverse_reads <- sort(list.files(rawdata_path, pattern="_2.fastq.gz", full.names = TRUE)))
(sample.names <- sapply(strsplit(basename(forward_reads), "_"), `[`, 1))
(sample.names <- as.character(unlist(lapply(sample.names,getid))))
...
##VANGAY###
rawdata_path <- "results/16s/processing/16s_vangay_2018/cutadapt_fastq"   
outdir <-  "results/16s/processing/16s_vangay_2018/DADA2" 
...
##MOELLER_CHIMP###
#define input fastqs, sample names, outdir
rawdata_path <- "results/16s/processing/16s_moeller_wild/chimp/cutadapt_fastq"   
outdir <-  "results/16s/processing/16s_moeller_wild/chimp/DADA2" 
...
###MOELLER_GORBON###
#define input fastqs, sample names, outdir
rawdata_path <-  "results/16s/processing/16s_moeller_wild/gor_bon/demultiplexed_fastq" 
outdir <-  "results/16s/processing/16s_moeller_wild/gor_bon/DADA2" 
(forward_reads <- sort(list.files(rawdata_path, pattern=".fastq.gz", full.names = TRUE)))
