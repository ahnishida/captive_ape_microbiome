...
#This script uses cutadapt to determine which datasets require primers to be removed,
#and then removes primers from select datasets

#trial cutadapt for one sample of each dataset shows only
#raymann (FandR primers),projectchimps (FandR primers),
#vangay (FandR primer), and moeller chimp (R primer)
#require primer trimming
...
rm test1.fastq; rm test2.fastq #remove test fastqs
