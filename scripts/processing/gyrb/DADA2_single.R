...
#process unfiltered fastqs, performs QC, read trimming, error correction, chimera checking
#inputs: amplicon fastqs
#output: asv table where rows are sample names, columns are seqs, and values are read counts
